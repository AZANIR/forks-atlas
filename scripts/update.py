...
CATEGORIES = [
    {
        ...
        "blurb": (
            "Форки навчальних завдань GitHub Classroom і курсових репозиторіїв. "
            "Активної цінності не мають, але видаляти їх — це стирати власну історію: "
            "по них видно, з чого починався шлях у DevOps і автоматизацію. "
            "Тримаються окремо, щоб не засмічувати робочі категорії."
        ),
