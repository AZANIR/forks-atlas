![Атлас проєктів @AZANIR — 314 проєктів](assets/readme/hero.svg)
...
**Швидкий перехід** · [Архів](docs/archive.md) 4 · [Безпека](docs/security.md) 38 · [QA](docs/qa.md) 30 · [Skills](docs/skills.md) 48 · [LLM-інфра](docs/llm-infra.md) 18 · [Пам'ять](docs/memory.md) 25 · [Медіа](docs/media.md) 26 · [Агенти](docs/agents.md) 88 · [DevOps](docs/devops.md) 14 · [Ресурси](docs/resources.md) 15 · [Веб](docs/web.md) 8
...
`314 проєктів` · `8 407 599 ★ сумарно` · `11 тек` · `оновлено 19.08.2026`
