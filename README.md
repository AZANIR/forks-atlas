...
Форки навчальних завдань GitHub Classroom і курсових репозиторіїв. Активної цінності не мають, але видаляти їх — це стирати власну історію: по них видно, з чого починався шлях у DevOps і автоматизацію. Тримаються окремо, щоб не засмічувати робочі категорії.
...
| [user-scanner](https://github.com/AZANIR/user-scanner) | [kaifcodec/user-scanner](https://github.com/kaifcodec/user-scanner) | 2 877 | Python | 🕵️‍♂️ (2-in-1) Email & Username OSINT suite for deep data extraction. Analyzes 360+ scan vectors (140+ email / 220+ username) for security research, investigations,… |
...
| [awesome-openclaw-usecases](https://github.com/AZANIR/awesome-openclaw-usecases) 📋 | [hesamsheikh/awesome-openclaw-usecases](https://github.com/hesamsheikh/awesome-openclaw-usecases) | 31 640 | — | A community collection of OpenClaw use cases for making life easier. |
...
| [awesome-agent-skills](https://github.com/AZANIR/awesome-agent-skills) 📋 | [VoltAgent/awesome-agent-skills](https://github.com/VoltAgent/awesome-agent-skills) | 29 197 | — | A curated collection of 1000+ agent skills from official dev teams and the community, compatible with Claude Code, Codex, Gemini CLI, Cursor, and more. |
...
| [scroll-world](https://github.com/AZANIR/scroll-world) | [oso95/scroll-world](https://github.com/oso95/scroll-world) | 5 711 | JavaScript | A skill that turn any brand into a scrollable 3D world |
...
| Проєкт | Оригінал | ★ | Мова | Що це |
| --- | --- | --: | --- | --- |
| [graphify](https://github.com/AZANIR/graphify) | [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify) | 98 273 | Python | Turn any codebase, with its docs, SQL schemas, configs, and PDFs, into a queryable knowledge graph. A /graphify skill for Claude Code, Cursor, Codex, and Gemini… |
| [claude-mem](https://github.com/AZANIR/claude-mem) | [thedotmack/claude-mem](https://github.com/thedotmack/claude-mem) | 88 951 | JavaScript | Persistent Context Across Sessions for Every Agent – Captures everything your agent does during sessions, compresses it with AI, and injects relevant context back… |
...
| [openhuman](https://github.com/AZANIR/openhuman) | [tinyhumansai/openhuman](https://github.com/tinyhumansai/openhuman) | 35 641 | Rust | Your Personal AI super intelligence. A brain that builds a local-first memory of your life, a fantastic orchestrator of agent fleets and workflows, and a deep… |
...
| Проєкт | Оригінал | ★ | Мова | Що це |
| --- | --- | --: | --- | --- |
| [markitdown](https://github.com/AZANIR/markitdown) | [microsoft/markitdown](https://github.com/microsoft/markitdown) | 169 993 | Python | Python tool for converting files and office documents to Markdown. |
...
| [penpot](https://github.com/AZANIR/penpot) | [penpot/penpot](https://github.com/penpot/penpot) | 57 683 | Clojure | Penpot: The open-source design platform for Product teams that need scalable collaboration. |
| [OpenMontage](https://github.com/AZANIR/OpenMontage) | [calesthio/OpenMontage](https://github.com/calesthio/OpenMontage) | 43 799 | Python | World's first open-source, agentic video production system. 12 production pipelines, 100+ tools, 700+ agent skill and production-knowledge files. Turn your AI… |
...
| [career-ops](https://github.com/AZANIR/career-ops) | [santifer/career-ops](https://github.com/santifer/career-ops) | 62 145 | JavaScript | Open-source AI job search: scan job portals, evaluate listings with a structured A-F rubric into a 1.0-5.0 score, tailor your CV, track applications — runs locally… |
| [BMAD-METHOD](https://github.com/AZANIR/BMAD-METHOD) | [bmad-code-org/BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD) | 51 249 | JavaScript | Breakthrough Method for Agile Ai Driven Development |
...
| [agents.md](https://github.com/AZANIR/agents.md) | [agentsmd/agents.md](https://github.com/agentsmd/agents.md) | 23 295 | TypeScript | AGENTS.md — a simple, open format for guiding coding agents |
| [n8n-mcp](https://github.com/AZANIR/n8n-mcp) | [czlonkowski/n8n-mcp](https://github.com/czlonkowski/n8n-mcp) | 22 440 | TypeScript | A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8n workflows for you |
...
| Проєкт | Оригінал | ★ | Мова | Що це |
| --- | --- | --: | --- | --- |
| [the-book-of-secret-knowledge](https://github.com/AZANIR/the-book-of-secret-knowledge) 📋💤 | [trimstray/the-book-of-secret-knowledge](https://github.com/trimstray/the-book-of-secret-knowledge) | 235 729 | — | A collection of inspiring lists, manuals, cheatsheets, blogs, hacks, one-liners, cli/web tools and more. |
...
| [ai-agent-book](https://github.com/AZANIR/ai-agent-book) | [bojieli/ai-agent-book](https://github.com/bojieli/ai-agent-book) | 26 093 | Python | 《深入理解 AI Agent：设计原理与工程实践》（李博杰 著）开源主仓库：全书正文、编译版 PDF 与按章配套代码 **— книга китайською; цінна саме розділами про пам'ять і контекст, код доданий покроково** |
