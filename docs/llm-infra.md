...
| [altic-dev/FluidVoice](https://github.com/altic-dev/FluidVoice) | 9 101 | Swift | Fastest and only macOS Dictation app with on-device STT and custom trained AI enhancement model. A local Wispr Flow alternative. ⭐ helps a ton :) Windows & iOS… |
