...
| [tinyhumansai/openhuman](https://github.com/tinyhumansai/openhuman) | 35 654 | Rust | Your Personal AI super intelligence. A brain that builds a local-first memory of your life, a fantastic orchestrator of agent fleets and workflows, and a deep… |
| [NirDiamant/RAG_Techniques](https://github.com/NirDiamant/RAG_Techniques) | 28 866 | Jupyter Notebook | This repository showcases various advanced techniques for Retrieval-Augmented Generation (RAG) systems. Each technique has a detailed notebook tutorial. |
| [rohitg00/agentmemory](https://github.com/rohitg00/agentmemory) | 25 966 | TypeScript | #1 Persistent memory for AI coding agents based on real-world benchmarks |
| [HKUDS/RAG-Anything](https://github.com/HKUDS/RAG-Anything) | 22 469 | Python | "RAG-Anything: All-in-One RAG Framework" |
| [teng-lin/notebooklm-py](https://github.com/teng-lin/notebooklm-py) | 18 326 | Python | Unofficial Python API and agentic skill for Google NotebookLM. Full programmatic access to NotebookLM's features—including capabilities the web UI doesn't… |
...
| [plastic-labs/honcho](https://github.com/plastic-labs/honcho) | 6 304 | Python | Memory library for building stateful agents |
...
| [breferrari/obsidian-mind](https://github.com/breferrari/obsidian-mind) | 4 119 | TypeScript | A self-organizing Obsidian vault that gives AI coding agents persistent memory. Claude Code, Codex CLI, Gemini CLI. |
