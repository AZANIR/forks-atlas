...
| [Agents365-ai/drawio-skill](https://github.com/Agents365-ai/drawio-skill) | 6 860 | Python | Generate draw.io diagrams from natural language — 11 presets (UML, SysML/MBSE, BPMN, network, C4…), 36 tools: codebase/CI/infra-to-diagram, image→editable diagram,… |
