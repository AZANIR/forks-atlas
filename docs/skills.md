...
| [github/awesome-copilot](https://github.com/github/awesome-copilot) 📋 | 37 199 | Python | Community-contributed instructions, agents, skills, and configurations to help you make the most of GitHub Copilot. |
| [hesamsheikh/awesome-openclaw-usecases](https://github.com/hesamsheikh/awesome-openclaw-usecases) 📋 | 31 645 | — | A community collection of OpenClaw use cases for making life easier. |
| [openai/codex-plugin-cc](https://github.com/openai/codex-plugin-cc) | 30 361 | JavaScript | Use Codex from Claude Code to review code or delegate tasks. |
| [VoltAgent/awesome-agent-skills](https://github.com/VoltAgent/awesome-agent-skills) 📋 | 29 200 | — | A curated collection of 1000+ agent skills from official dev teams and the community, compatible with Claude Code, Codex, Gemini CLI, Cursor, and more. |
| [jarrodwatts/claude-hud](https://github.com/jarrodwatts/claude-hud) | 26 939 | JavaScript | A Claude Code plugin that shows what's happening - context usage, active tools, running agents, and todo progress |
| [agentskills/agentskills](https://github.com/agentskills/agentskills) | 23 637 | Python | Specification and documentation for Agent Skills |
| [EveryInc/compound-engineering-plugin](https://github.com/EveryInc/compound-engineering-plugin) | 23 600 | TypeScript | Official Compound Engineering plugin for Claude Code, Codex, Cursor, and more |
...
| [emilkowalski/skills](https://github.com/emilkowalski/skills) | 22 494 | — | Skills for Design Engineers. |
...
| [nyldn/claude-octopus](https://github.com/nyldn/claude-octopus) | 3 900 | Shell | Surface AI blindspots before you ship. Put up to 8 AI models on every research, design or coding task. |
