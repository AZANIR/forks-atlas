...
| --- | --- | --: | --- | --- |
| [tw93/Pake](https://github.com/tw93/Pake) 🔗 | — | 61 708 | Rust | 🤱🏻 Turn any webpage into a desktop app with one command. |
| [CorentinTh/it-tools](https://github.com/CorentinTh/it-tools) 📋🔗 | — | 40 678 | Vue | Collection of handy online tools for developers, with great UX. |
| [birobirobiro/awesome-shadcn-ui](https://github.com/birobirobiro/awesome-shadcn-ui) 📋🔗 | — | 20 556 | TypeScript | A curated list of awesome things related to shadcn/ui. |
