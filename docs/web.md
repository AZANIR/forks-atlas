...
| Проєкт | ★ | Мова | Що це |
| --- | --: | --- | --- |
| [tw93/Pake](https://github.com/tw93/Pake) | 60 309 | Rust | 🤱🏻 Turn any webpage into a desktop app with one command. |
| [CorentinTh/it-tools](https://github.com/CorentinTh/it-tools) 📋 | 39 994 | Vue | Collection of handy online tools for developers, with great UX. |
