...
| [github/spec-kit](https://github.com/github/spec-kit) | 124 477 | Python | 💫 Toolkit to help you get started with Spec-Driven Development |
| [karpathy/autoresearch](https://github.com/karpathy/autoresearch) | 92 334 | Python | AI agents running research on single-GPU nanochat training automatically |
...
| [karpathy/llm-council](https://github.com/karpathy/llm-council) | 23 340 | Python | LLM Council works together to answer your hardest questions |
| [agentsmd/agents.md](https://github.com/agentsmd/agents.md) | 23 297 | TypeScript | AGENTS.md — a simple, open format for guiding coding agents |
...
| [sirmalloc/ccstatusline](https://github.com/sirmalloc/ccstatusline) | 12 097 | TypeScript | 🚀 Beautiful highly customizable statusline for Claude Code CLI with powerline support, themes, and more. |
...
| [CodebuffAI/codebuff](https://github.com/CodebuffAI/codebuff) | 8 075 | TypeScript | Generate code from the terminal! |
...
| [craft-ai-agents/craft-agents-oss](https://github.com/craft-ai-agents/craft-agents-oss) | 6 975 | TypeScript | — |
...
| [Pickle-Pixel/ApplyPilot](https://github.com/Pickle-Pixel/ApplyPilot) | 1 358 | Python | AI agent that applies to jobs for you. Any site. Any form. |
...
| [andyrewlee/awesome-agent-orchestrators](https://github.com/andyrewlee/awesome-agent-orchestrators) 📋 | 1 158 | — | List of agent orchestrators |
...
| [ShenSeanChen/waku-agent](https://github.com/ShenSeanChen/waku-agent) | 609 | Python | Waku Waku! Waku agent is your personal AI agent, on your own laptop, in code you can read in an afternoon — harness + loop + memory + eval |
| [yashab-cyber/opendroid](https://github.com/yashab-cyber/opendroid) | 501 | Kotlin | Your Open Autonomous Android Agent — A production-ready, self-planning AI assistant powered by local/remote LLMs and accessibility-driven screen automation. |
