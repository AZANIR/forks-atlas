...
| [nexu-io/harness-engineering-guide](https://github.com/nexu-io/harness-engineering-guide) | 601 | TypeScript | 🔧 The open guide to Harness Engineering — concepts, tutorials, papers, tools, and resources for building and managing AI agent runtimes. |
| [justxor/MachineLearningRoadmap](https://github.com/justxor/MachineLearningRoadmap) | 326 | — | Полный Roadmap по машинному обучению 2026 |
