...
| [currents-dev/playwright-best-practices-skill](https://github.com/currents-dev/playwright-best-practices-skill) | 349 | — | AI Skill for Playwright Best Practices—made by Currents.dev |
| [LambdaTest/agent-skills](https://github.com/LambdaTest/agent-skills) | 347 | Python | AI agent skills for TestMu AI (Formerly LambdaTest). |
...
| [bmad-code-org/bmad-method-test-architecture-enterprise](https://github.com/bmad-code-org/bmad-method-test-architecture-enterprise) | 88 | JavaScript | Test Architect Full BMad Method Enhancement |
