...
| Проєкт | ★ | Мова | Що це |
| --- | --: | --- | --- |
| [danielmiessler/SecLists](https://github.com/danielmiessler/SecLists) 📋 | 72 487 | PHP | SecLists is the security tester's companion. It's a collection of multiple types of lists used during security assessments, collected in one place. List types… |
...
| [usestrix/strix](https://github.com/usestrix/strix) | 45 568 | Python | Open-source AI penetration testing tool to find and fix your app’s vulnerabilities. |
...
| [mukul975/Anthropic-Cybersecurity-Skills](https://github.com/mukul975/Anthropic-Cybersecurity-Skills) | 26 877 | Python | 817 structured cybersecurity skills for AI agents · Mapped to 6 frameworks: MITRE ATT&CK, NIST CSF 2.0, MITRE ATLAS, D3FEND, NIST AI RMF & MITRE F3 (Fight Fraud) ·… |
...
| [kaifcodec/user-scanner](https://github.com/kaifcodec/user-scanner) | 2 879 | Python | 🕵️‍♂️ (2-in-1) Email & Username OSINT suite for deep data extraction. Analyzes 360+ scan vectors (140+ email / 220+ username) for security research, investigations,… |
