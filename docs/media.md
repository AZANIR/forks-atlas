...
| [perminder-klair/subwave](https://github.com/perminder-klair/subwave) | 1 077 | TypeScript | Personal internet radio: Agentic AI DJ **— агентне за реалізацією, але артефакт — ефір: AI-діджей добирає треки й говорить між ними** |
| [kizuna-ai-lab/sokuji](https://github.com/kizuna-ai-lab/sokuji) | 1 031 | TypeScript | Real-time two-way speech translation for bilingual meetings — auto-detects the spoken language and translates both directions, cloud or fully offline on-device.… |
