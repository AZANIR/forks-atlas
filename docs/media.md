...
| [Zackriya-Solutions/meetily](https://github.com/Zackriya-Solutions/meetily) 🔗 | — | 30 712 | Rust | Privacy first, AI meeting assistant with 4x faster Parakeet/Whisper live transcription, speaker diarization, and Ollama summarization built on Rust. 100% local… **— правила чіпляються за privacy first, але це транскрибування зустрічей** |
| [opendataloader-project/opendataloader-pdf](https://github.com/opendataloader-project/opendataloader-pdf) 🔗 | — | 29 147 | Java | PDF Parser for AI-ready data. Automate PDF accessibility. Open-source. |
| [webadderallorg/Recordly](https://github.com/webadderallorg/Recordly) 🔗 | — | 28 256 | TypeScript | Create polished demo videos without editing skills. Mac/Windows/Linux **— screen recorder для demo-відео; слово skills у описі збиває в skill-паки** |
| [bradautomates/claude-video](https://github.com/bradautomates/claude-video) 🔗 | — | 17 163 | Python | Give Claude the ability to watch any video. /watch downloads, extracts frames, transcribes, hands it all to Claude. |
| [deepbeepmeep/Wan2GP](https://github.com/deepbeepmeep/Wan2GP) 🔗 | — | 9 313 | Python | A fast AI Video Generator for the GPU Poor. Supports Wan 2.1/2.2, LTX-2, Qwen Image, Hunyuan Video, LTX Video and Flux. |
| [XiaoYouChR/Ghost-Downloader-3](https://github.com/XiaoYouChR/Ghost-Downloader-3) 🔗 | — | 9 013 | Python | The only downloader you need. 下载器的集大成者。 |
| [Vincentwei1021/video-shotcraft](https://github.com/Vincentwei1021/video-shotcraft) 🔗 | — | 8 393 | TypeScript | AI video skill for Claude Code & Codex — cinematic product videos with Remotion: 152 shot recipe cards, 209 motion previews, a production-ready template **— skill-пак, але артефакт — кінематографічне відео; skill у описі збиває в skill-паки** |
| [opentoonz/opentoonz](https://github.com/opentoonz/opentoonz) 🔗 | — | 7 721 | C++ | OpenToonz - An open-source full-featured 2D animation creation software |
...
| [lnkiai/m3e-canvas](https://github.com/lnkiai/m3e-canvas) 🔗 | — | 6 473 | TypeScript | Sketch Material 3 Expressive screens in the browser and turn them into vibe-coding prompts. |
...
| [kane50613/takumi](https://github.com/kane50613/takumi) 🔗 | — | 2 980 | Rust | Render OG images and paged PDFs from JSX, HTML, and CSS. No headless browser. Runs on Node.js, Cloudflare Workers, browsers, and Rust. |
| [walterlow/freecut](https://github.com/walterlow/freecut) 🔗 | — | 2 168 | TypeScript | FreeCut is a professional-grade video editor that runs entirely in your browser. Professional video editing, zero installation. Create stunning videos with… |
| [kacperkapusciak/goldie](https://github.com/kacperkapusciak/goldie) 🔗 | — | 2 038 | TypeScript | ✨ agentic app store previews and screenshots **— генерує скріншоти й preview-відео для app store; написаний для coding-агентів, тому agentic тягне в агентів** |
| [perminder-klair/subwave](https://github.com/perminder-klair/subwave) 🔗 | — | 1 321 | TypeScript | Personal internet radio: Agentic AI DJ **— агентне за реалізацією, але артефакт — ефір: AI-діджей добирає треки й говорить між ними** |
| [techjarves/Uncensored-Local-Studio](https://github.com/techjarves/Uncensored-Local-Studio) 🔗 | — | 1 316 | JavaScript | Uncensored local AI studio for Windows, Linux, and macOS. Zero-setup GUI for Image Generation, GGUF LLMs, Text to Speech & Speech to Text |
| [kizuna-ai-lab/sokuji](https://github.com/kizuna-ai-lab/sokuji) 🔗 | — | 1 293 | TypeScript | Real-time two-way speech translation for bilingual meetings — auto-detects the spoken language and translates both directions, cloud or fully offline on-device.… |
| [Formsmith746/SketchForge-3D](https://github.com/Formsmith746/SketchForge-3D) 🔗 | — | 1 020 | TypeScript | A local-first browser 3D design editor for building, cutting, importing STL files, and exporting models. |
